...
_Note: If testing on a mobile device on the same network, replace `localhost` with your machine's local IP address (e.g., `http://192.168.1.5:5000/api`)._
...
_The server will start on port 5000._
...
_The client will start on the port provided by Vite (usually 5173)._
